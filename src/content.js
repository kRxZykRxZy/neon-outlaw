...
export const VEHICLES={
  runner:{name:'NOVA RUNNER',price:0,topSpeed:42,accel:18,brake:28,handling:3.2,health:800,color:0x20eaff},
  viper:{name:'VIPER GT',price:9000,topSpeed:58,accel:24,brake:34,handling:3.8,health:850,color:0xff267e},
  phantom:{name:'PHANTOM XR',price:24000,topSpeed:72,accel:30,brake:38,handling:4.4,health:1000,color:0x9b5cff},
  titan:{name:'TITAN ARMORED',price:50000,topSpeed:43,accel:15,brake:25,handling:2.5,health:2400,color:0x657080},
  specter:{name:'SPECTER',price:85000,topSpeed:84,accel:36,brake:45,handling:5.2,health:1100,color:0x65ffb3}
};
export const DISTRICTS=[
 {id:'dock',name:'BLACKWATER DOCKS',center:[-520,0,-420],radius:430,level:1,color:0x00b9d8},
 {id:'market',name:'NEON MARKET',center:[0,0,-420],radius:420,level:2,color:0xff2bc2},
 {id:'midtown',name:'MIDTOWN',center:[460,0,-80],radius:500,level:3,color:0x9b5cff},
 {id:'old',name:'OLD QUARTER',center:[-430,0,340],radius:440,level:4,color:0xff8d36},
 {id:'corporate',name:'ZENITH DISTRICT',center:[350,0,430],radius:520,level:5,color:0x63ffb4},
 {id:'outskirts',name:'THE OUTSKIRTS',center:[-20,0,850],radius:620,level:6,color:0xffd43d}
];
export const MISSIONS=[
{id:'m01',chapter:1,title:'FIRST NIGHT',district:'dock',type:'drive',brief:'Meet Jax beneath the dead billboard.',reward:900,xp:100,unlock:0,target:'Jax',distance:160},
{id:'m02',chapter:1,title:'NO QUESTIONS',district:'dock',type:'combat',brief:'Clear the warehouse before the shipment moves.',reward:1600,xp:180,unlock:1,target:'Enemies',kills:8},
{id:'m03',chapter:1,title:'HOT PACKAGE',district:'dock',type:'delivery',brief:'Steal the runner and deliver it to the safehouse.',reward:2100,xp:240,unlock:2,target:'Safehouse'},
...
{id:'m05',chapter:1,title:'NIGHT SHIFT',district:'market',type:'drive',brief:'Get across Neon Market before the gates close.',reward:3200,xp:360,unlock:4,target:'Checkpoint',distance:520},
...
{id:'m08',chapter:1,title:'REDLINE',district:'market',type:'race',brief:'Beat the Vultures to the elevated highway.',reward:5200,xp:600,unlock:7,target:'Race',distance:1400},
...
{id:'m10',chapter:2,title:'CLEAN EXIT',district:'midtown',type:'escape',brief:'Lose the police after the Midtown robbery.',reward:7800,xp:820,unlock:9,target:'Wanted',stars:3,distance:1100},
...
{id:'m14',chapter:2,title:'OLD BLOOD',district:'old',type:'drive',brief:'Find the original safehouse in the Old Quarter.',reward:13500,xp:1350,unlock:13,target:'Safehouse',distance:1000},
...
export const LOOT=[
{name:'Cash Roll',value:250,weight:50},{name:'Encrypted Chip',value:600,weight:24},{name:'Gold Watch',value:1200,weight:12},{name:'Prototype Cell',value:3000,weight:7},{name:'Black Diamond',value:7500,weight:3},{name:'Unknown Key',value:15000,weight:1}
];
